...
export default function About() {
	return (
		<div className="pt-32 min-h-screen bg-gray-300 flex flex-col justify-center">
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center">
					<h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
						About <span className="text-indigo-600">sCode</span>
					</h2>
					<p className="m-6 text-lg leading-6 text-gray-600 text-justify">
					...
					<p className="m-6 text-lg leading-6 text-gray-600 text-justify">
						...
						Understanding (NLU) is enhanced with <span className="font-bold">Dialogflow</span>, ensuring sCode
						understands and responds to a wide range of developer inquiries with precision.
					</p>
				</div>
